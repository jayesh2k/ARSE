...
<div class="container-fluid">
    <form action="" id="login-frm">
        ...
        <div class="form-group">
            ...
            <div class="invalid-feedback">Please enter a secure password with at least one letter, one number, one special character, and a minimum length of 6 characters.</div>
        </div>
...
<script>
    $('#login-frm').submit(function(e) {
        e.preventDefault();
        var isValid = this.checkValidity(); // Check form validity using HTML5 form validation
        if (isValid) {
            ...
            // Form is invalid, handle invalid form submission
