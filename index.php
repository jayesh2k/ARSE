...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <h2>Subscribe for Updates and Latest Jobs</h2>
        <p>Subscribe for free to get the latest updates and job opportunities straight to your inbox!</p>
 ...
 <script>
  ...
  $(document).ready(function() {
    ...
    $('#subscribe_form').submit(function(event) {
      ...
      var email = $(this).find('input[name="email"]').val(); // Get email value
    ...
    function subscribe(email) {
      $.ajax({
        url: 'subscribe.php', // PHP script to handle the subscription
        method: 'POST',
        data: { email: email }, // Data to send to the server
        ...
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2024 Free Thinkers - <?php echo $_SESSION['system']['name'] ?> </div></div>
        </footer>
